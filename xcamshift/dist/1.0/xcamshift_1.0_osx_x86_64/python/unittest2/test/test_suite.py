...
def _mk_TestSuite(*names):
    return unittest2.TestSuite(TestObservedShiftTable.Foo(n) for n in names)
...
class Test_TestSuite(unittest2.TestCase, EqualityMixin):
    ...
    def test_basetestsuite(self):
        ...
        suite.addTests([TestObservedShiftTable('testPass'), TestObservedShiftTable('testFail')])
        self.assertEqual(suite.countTestCases(), 2)
        ...
        self.assertFalse(TestObservedShiftTable.wasSetUp)
        self.assertFalse(TestObservedShiftTable.wasTornDown)
