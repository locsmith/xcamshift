...
class TestObservedShiftTable(object):
    ...
    class LoggingTestCase(unittest2.TestCase):
        ...
        def __init__(self, events):
            super(TestObservedShiftTable.LoggingTestCase, self).__init__('test')
            self.events = events
...
class Test_TestCase(unittest2.TestCase, EqualityMixin, HashingMixin):
    ...
    eq_pairs = [(TestObservedShiftTable.Foo('test1'), TestObservedShiftTable.Foo('test1'))]

    # Used by EqualityMixin.test_ne
    ne_pairs = [(TestObservedShiftTable.Foo('test1'), TestObservedShiftTable.Foo('runTest')),
                (TestObservedShiftTable.Foo('test1'), TestObservedShiftTable.Bar('test1')),
                (TestObservedShiftTable.Foo('test1'), TestObservedShiftTable.Bar('test2'))]
    ...
    def test_init__no_test_name(self):
        ...
        self.assertEqual(TestObservedShiftTable().id()[-13:], '.TestObservedShiftTable.runTest')
    ...
    def test_init__test_name__valid(self):
        ...
        self.assertEqual(TestObservedShiftTable('test').id()[-10:], '.TestObservedShiftTable.test')
    ...
    def test_init__test_name__invalid(self):
        ...
        try:
            TestObservedShiftTable('testfoo')
        except ValueError:
            pass
        else:
    ...
    def test_run_call_order__error_in_setUp(self):
        ...
        class Foo(TestObservedShiftTable.LoggingTestCase):
            def setUp(self):
    ...
    def testAssertItemsEqual(self):
        ...
        # TestObservedShiftTable that sequences of unhashable objects can be tested for sameness:
        ...
        # TestObservedShiftTable unsortable objects
...
"""
    ...
    def testSynonymAssertMethodNames(self):
        """TestObservedShiftTable undocumented method name synonyms.
