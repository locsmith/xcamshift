...
class TestWith(unittest2.TestCase):
    ...
    def test_old_testresult(self):
        ...
        for test_name, should_pass in (('testSkip', True), 
            ...
            test = TestObservedShiftTable(test_name)
    ...
    def test_old_testresult_setup(self):
        class TestObservedShiftTable(unittest2.TestCase):
            ...
            def testFoo(self):
                pass
        self.assertOldResultWarning(TestObservedShiftTable('testFoo'), 0)
        
    def test_old_testresult_class(self):
        class TestObservedShiftTable(unittest2.TestCase):
            def testFoo(self):
                pass
        TestObservedShiftTable = unittest2.skip('no reason')(TestObservedShiftTable)
        self.assertOldResultWarning(TestObservedShiftTable('testFoo'), 0)

    def testPendingDeprecationMethodNames(self):
        """TestObservedShiftTable fail* methods pending deprecation, they will warn in 3.2.
