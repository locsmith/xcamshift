...
class Test_TestLoader(unittest2.TestCase):
    ...
    #
    # TestObservedShiftTable.foobar is defined to make sure getTestCaseNames() respects
    ...
    def test_getTestCaseNames(self):
        ...
        self.assertEqual(loader.getTestCaseNames(TestObservedShiftTable), ['test_1', 'test_2'])
    ...
    def test_getTestCaseNames__no_tests(self):
        ...
        self.assertEqual(loader.getTestCaseNames(TestObservedShiftTable), [])
